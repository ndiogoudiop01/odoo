...
class TestCPA005(AccountTestInvoicingCommon):
    ...
    def test_cpa005(self):
        ...
        expected_item_trace_numbers = [f"{payment.id:022d}" for payment in self.batch.payment_ids.sorted("id")]
        expected = [
            # A record ("header")
            "A0000000011234567890010302033501600                    CAD                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ",
            # C records ("outgoing payments")
            f"C000000002123456789001034300000045678020336077788888444444444   {expected_item_trace_numbers[2]}000COMP_NAME      partner_b                     Long Company Name             1234567890                   0222333339999999                                            00000000000                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ",
            f"C000000003123456789001032000000056789020335077788888444444444   {expected_item_trace_numbers[3]}000COMP_NAME      partner_b                     Long Company Name             1234567890                   0222333339999999                                            00000000000                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ",
            f"C000000004123456789001034300000054321020335055566666333333333   {expected_item_trace_numbers[1]}000COMP_NAME      partner_a                     Long Company Name             1234567890                   0222333339999999                                            00000000000                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ",
            f"C000000005123456789001034300000012345020335055566666333333333   {expected_item_trace_numbers[0]}000COMP_NAME      partner_a                     Long Company Name             1234567890                   0222333339999999                                            00000000000                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ",
            # Z record ("footer")
