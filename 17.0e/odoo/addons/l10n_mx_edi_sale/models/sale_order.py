...
class SaleOrder(models.Model):
    ...
    @api.depends('company_id', 'partner_id.l10n_mx_edi_partner_address_complete')
    def _compute_l10n_mx_edi_cfdi_to_public(self):
        for order in self:
            order.l10n_mx_edi_cfdi_to_public = order.country_code == 'MX' and not order.partner_id.l10n_mx_edi_partner_address_complete
