    ...
    def _process_preparation_changes(self, cancelled=False, note_history=None):
        ...
        for data in quantity_data.values():
            ...
            if data['order'] > data['display']:
                ...
                sorted_lines = lines.sorted(key=lambda li: li.preparation_display_order_id.order_stage_ids[-1].stage_id.sequence if li.preparation_display_order_id.order_stage_ids else 0)
