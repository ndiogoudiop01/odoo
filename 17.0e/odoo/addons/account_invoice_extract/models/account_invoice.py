                ...
                if partner_id:
                    ...
                    if created and iban_ocr and not move_form.partner_bank_id and self.is_purchase_document():
                        ...
                        if SWIFT_code_ocr:
                            ...
                            if bank_id:
                                extra_create_vals['bank_id'] = bank_id.id
                            if not bank_id and SWIFT_code_ocr['verified_bic']:
                                ...
                                if country_id:
                                    extra_create_vals['bank_id'] = self.env['res.bank'].create({'name': SWIFT_code_ocr['name'], 'country': country_id.id, 'city': SWIFT_code_ocr['city'], 'bic': SWIFT_code_ocr['bic']}).id
