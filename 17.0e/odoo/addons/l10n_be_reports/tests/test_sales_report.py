...
class BelgiumSalesReportTest(AccountSalesReportCommon):
    ...
    def test_be_ec_sales_report_refund(self):
        self._create_invoices([(self.partner_a, self.l_tax, 100), (self.partner_a, self.t_tax, 90), (self.partner_a, self.s_tax, 80)])
        self._create_invoices([(self.partner_a, self.l_tax, 42), (self.partner_a, self.t_tax, 42), (self.partner_a, self.s_tax, 42)], is_refund=True)
