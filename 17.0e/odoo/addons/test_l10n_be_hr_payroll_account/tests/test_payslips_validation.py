...
class TestPayslipValidation(AccountTestInvoicingCommon):
    ...
    def test_public_holiday_right_sick_leaves(self):
        ...
        self.assertAlmostEqual(payslip._get_worked_days_line_amount('LEAVE110'), 1182.31, places=2)
        self.assertAlmostEqual(payslip._get_worked_days_line_amount('LEAVE214'), 0.0, places=2)
        self.assertAlmostEqual(payslip._get_worked_days_line_amount('LEAVE500'), 122.31, places=2)

        self.assertAlmostEqual(payslip._get_worked_days_line_number_of_days('LEAVE110'), 9.0, places=2)
        self.assertAlmostEqual(payslip._get_worked_days_line_number_of_days('LEAVE214'), 11.0, places=2)
        self.assertAlmostEqual(payslip._get_worked_days_line_number_of_days('LEAVE500'), 1.0, places=2)

        self.assertAlmostEqual(payslip._get_worked_days_line_number_of_hours('LEAVE110'), 68.4, places=2)
        self.assertAlmostEqual(payslip._get_worked_days_line_number_of_hours('LEAVE214'), 83.6, places=2)
        self.assertAlmostEqual(payslip._get_worked_days_line_number_of_hours('LEAVE500'), 7.6, places=2)
    ...
    def test_n1_holiday_pay_recovery_40_hours_working_schedule(self):
        self.contract.date_start = datetime.date(2026, 1, 1)
        ...
        payslip_results_feb = {'BASIC': 3299.2, 'HolPayRecN1': -824.8, 'ATN.INT': 5.0, 'ATN.MOB': 4.0, 'SALARY': 2483.4, 'ONSS': -324.58, 'EmpBonus.1': 182.97, 'ONSSTOTAL': 141.61, 'ATN.CAR': 159.6, 'GROSSIP': 2501.39, 'IP.PART': -824.8, 'GROSS': 1676.59, 'P.P': -64.94, 'P.P.DED': 64.94, 'PPTOTAL': 0.0, 'ATN.CAR.2': -159.6, 'ATN.INT.2': -5.0, 'ATN.MOB.2': -4.0, 'M.ONSS': -22.53, 'MEAL_V_EMP': -16.35, 'REP.FEES': 150.0, 'IP': 824.8, 'IP.DED': -61.86, 'NET': 2382.05, 'REMUNERATION': 2474.4, 'ONSSEMPLOYERBASIC': 620.85, 'ONSSEMPLOYERCPAE': 5.71, 'ONSSEMPLOYERFFE': 1.74, 'ONSSEMPLOYERMFFE': 2.48, 'ONSSEMPLOYERRESTREINT': 41.97, 'ONSSEMPLOYERUNEMP': 2.48, 'ONSSEMPLOYER': 675.24, 'CO2FEE': 33.22}
        ...
        payslip_results_dec = {'BASIC': 3794.08, 'HolPayRecN1': -824.8, 'ATN.INT': 5.0, 'ATN.MOB': 4.0, 'SALARY': 2978.28, 'ONSS': -389.26, 'EmpBonus.1': 55.97, 'ONSSTOTAL': 333.29, 'ATN.CAR': 159.6, 'GROSSIP': 2804.59, 'IP.PART': -948.52, 'GROSS': 1856.07, 'P.P': -112.18, 'P.P.DED': 18.55, 'PPTOTAL': 93.63, 'ATN.CAR.2': -159.6, 'ATN.INT.2': -5.0, 'ATN.MOB.2': -4.0, 'M.ONSS': -29.28, 'MEAL_V_EMP': -19.62, 'REP.FEES': 150.0, 'IP': 948.52, 'IP.DED': -71.14, 'NET': 2572.32, 'REMUNERATION': 2845.56, 'ONSSEMPLOYERBASIC': 744.57, 'ONSSEMPLOYERCPAE': 6.85, 'ONSSEMPLOYERFFE': 2.08, 'ONSSEMPLOYERMFFE': 2.98, 'ONSSEMPLOYERRESTREINT': 50.33, 'ONSSEMPLOYERUNEMP': 2.98, 'ONSSEMPLOYER': 809.79, 'CO2FEE': 33.22}
