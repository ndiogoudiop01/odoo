    ...
    def test_cz_vies_report(self):
        ...
        self.assertLinesValues(
            ...
            [
                ...
                ('Partner EU 4',        'BE',              '0477472701',            '',                    3,                        60),
                ('2 Triangular',        'BE',              '0477472701',            '2',                   3,                        60),
            ],
            options,
        )
    ...
    def test_cz_vies_report_default_options_export(self):
        ...
        expected_xml = f"""
            ...
            <DPHSHV verzePis="02.01">
                ...
                <VetaR k_stat="FR" c_vat="23334175221" k_pln_eu="0" pln_pocet="4" pln_hodnota="130.0"/>
                <VetaR k_stat="FR" c_vat="23334175221" k_pln_eu="1" pln_pocet="4" pln_hodnota="240.0"/>
                <VetaR k_stat="FR" c_vat="23334175221" k_pln_eu="2" pln_pocet="3" pln_hodnota="60.0"/>
                <VetaR k_stat="FR" c_vat="23334175221" k_pln_eu="3" pln_pocet="1" pln_hodnota="80.0"/>
                <VetaR k_stat="DE" c_vat="123456788"   k_pln_eu="1" pln_pocet="5" pln_hodnota="240.0"/>
                <VetaR k_stat="DE" c_vat="123456788"   k_pln_eu="3" pln_pocet="1" pln_hodnota="80.0"/>
                <VetaR k_stat="BE" c_vat="0477472701"  k_pln_eu="2" pln_pocet="3" pln_hodnota="60.0"/>
                <VetaR k_stat="BE" c_vat="0477472701"  k_pln_eu="2" pln_pocet="3" pln_hodnota="60.0"/>
            </DPHSHV>
            </Pisemnost>
        """
    ...
    def test_cz_vies_report_total_value_calculation_with_discount(self):
        ...
        self.assertLinesValues(
            ...
            [
                ...
                ('Partner EU 1',                    90),
                ('0 Goods',                         90),
                ('INV/2020/00001 Test Line',       100),
                ('INV/2020/00001 Discount Line',   -10),
            ],
            options,
        )
    ...
    def test_cz_vies_report_total_value_calculation_with_discount_refund(self):
        ...
        self.assertLinesValues(
            ...
            [
                ...
                ('Partner EU 1',                   -90),
                ('0 Goods',                        -90),
                ('RINV/2020/00001 Test Line',     -100),
                ('RINV/2020/00001 Discount Line',   10),
            ],
            options,
        )
