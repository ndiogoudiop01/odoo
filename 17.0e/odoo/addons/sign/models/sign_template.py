...
class SignItem(models.Model):
    ...
    def create(self, vals):
        ...
        res.template_id.check_access_rights('write')
        res.template_id.check_access_rule('write')
        return res

    def write(self, vals):
        res = super().write(vals)
        if 'template_id' in vals:
            self.template_id.check_access_rights('write')
            self.template_id.check_access_rule('write')
        return res
