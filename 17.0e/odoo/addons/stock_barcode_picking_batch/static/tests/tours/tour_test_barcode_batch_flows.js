...
registry.category("web_tour.tours").add('test_batch_create', {test: true, steps: () => [
    ...
    {
        trigger: '.o_notification.border-danger:contains("This batch transfer is still in draft, scans are disabled until the batch is confirmed") .o_notification_close',
        run: 'click',
    },
