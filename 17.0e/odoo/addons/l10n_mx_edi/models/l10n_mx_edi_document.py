...
class L10nMxEdiDocument(models.Model):
    ...
    def _add_base_lines_tax_amounts(self, base_lines, cfdi_values=None):
        ...
        for base_line in base_lines:
            ...
            # 'price_unit' is the source of truth for 'ValorUnitario': dividing the rounded
            # 'price_subtotal' by 'discount_factor' amplifies its rounding by 1 / discount_factor.
            if abs(gross_price_subtotal_before_discount * discount_factor - price_subtotal) > currency.rounding:
    ...
    def _add_base_lines_cfdi_values(self, cfdi_values, base_lines, percentage_paid=None):
        ...
        for line in base_lines:
            ...
            if is_refund_gi:
                ...
                product_unspsc_code = line.get('product_unspsc_code', product.unspsc_code_id.code)
                uom_unspsc_code = line.get('uom_unspsc_code', uom.unspsc_code_id.code)
    ...
    def _get_global_invoice_cfdi_values(self, cfdi_values_list, date, periodicity='04', origin=None):
        ...
        # Sequence:
        sequence = self._get_global_invoice_cfdi_sequence(company, create_if_missing=False)
        if not sequence:
