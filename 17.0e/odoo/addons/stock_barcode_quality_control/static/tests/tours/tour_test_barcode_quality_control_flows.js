...
registry
    ...
    .add("test_operation_quality_check_multi_step_internal_barcode", {
        test: true,
        steps: () => [
            {
            ...
            {
                trigger: ".o_barcode_header:contains('WH/INTSHELF1')",
                run: "scan product1",
            },
            {
            ...
            {
                trigger:
                    ".o_barcode_picking_type:has(.o_kanban_record_title:contains('Internal Stock → SHELF1'))",
            },
            {
                trigger: ".o_kanban_record:has(.o_kanban_record_title:contains('WH/INTSHELF1')) ",
            },
            {
                trigger: "button[name=incrementButton]",
            },
            {
