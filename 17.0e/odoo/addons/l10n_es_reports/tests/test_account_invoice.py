...
class TestAccountInvoice(TestAccountReportsCommon):
    ...
    def test_vat_record_books_with_receipts(self):
        ...
        self._test_xlsx_file(vat_record_books, {
            ...
            2: (2019, '12', 'A', '01', '0000', 'F2', 'I01', 3000, '12/31/2019', '', '', 'INV/2019/00002', '', '', '', '', '', '01', 'S1', '', 3630, 3000, 21, 630, 0, 0, '', '', '', '', 0, 0, '', '', '', ''),
            3: (2019, '12', 'A', '01', '0000', 'F1', 'I01', 5000, '12/31/2019', '', '', 'INV/2019/00001', '', '', '', '', 'España', '01', 'S1', '', 6050, 5000, 21, 1050, 0, 0, '', '', '', '', 0, 0, '', '', '', ''),
        })
