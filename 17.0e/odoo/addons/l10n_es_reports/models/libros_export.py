...
class GenericTaxReportCustomHandler(models.AbstractModel):
    ...
    def _l10n_es_fill_common_line_vals(self, company, partner, date, delivery_date, invoice_type, operation_code, amount):
        ...
        common_line_vals = {
            ...
            'date_expedition': format_date(self.env, date, date_format='MM/dd/yyyy'),
            'date_transaction': format_date(self.env, delivery_date, date_format='MM/dd/yyyy') if delivery_date and delivery_date != date else '',
    ...
    def _l10n_es_libros_get_common_line_vals(self, line, tax):
        ...
        exempt_reason = line.move_id.line_ids.tax_ids.filtered(lambda t: t.l10n_es_exempt_reason == 'E2')
