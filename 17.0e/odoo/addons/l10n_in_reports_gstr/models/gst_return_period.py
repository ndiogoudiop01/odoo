...
class L10nInGSTReturnPeriod(models.Model):
                ...
                if matched_bills:
                    ...
                    if len(matched_bills) == 1:
                        ...
                        if matched_bills.ref == gstr2b_bill.get('bill_number'):
                            ...
                            exception.append(_("Reference number as per GSTR-2B is %s", gstr2b_bill['bill_number']))
                        matched_bills.write({
    ...
    def _request(self, url, company, params=None):
        ...
        endpoint = IrConfigParam.get_param("l10n_in_reports_gstr.endpoint", default_endpoint)
