...
from .gstr_test_json import gstr1_test_json, gstr1_test_2_json, new_hsn_schema_gstr1_test_json, gstr1_sez_foreign_currency_test_json
import logging
...
class TestReports(TestAccountReportsCommon):
    ...
    def test_gstr1_foreign_currency_invoice_value(self):
        ...
        inv = self.init_invoice(
            ...
            partner=self.registered_partner_1,
            currency=foreign_currency,
            post=False,
        )
        inv.write({
            'l10n_in_gst_treatment': 'special_economic_zone',
            'invoice_line_ids': [Command.update(l.id, {'price_unit': 10}) for l in inv.invoice_line_ids],
        })
        inv.action_post()
        ...
        self.assertDictEqual(gstr1_json, gstr1_sez_foreign_currency_test_json)
